...
var $strongName = '1D08264CC34EF686CB0017DBDA043BE5';
...
function $loadPlayer(this$static, id_0){
  ...
  var options = this$static.options.toJS_0();
...
function $loadSources(this$static, sources){
  this$static.options.playlist_0 = dynamicCast($toArray(sources), Q$JWPlayerOptions$JWPlayerPlaylistSource_$1);
  if (this$static.playerLoaded) {
    $loadPlayer(this$static, this$static.playerId);
    $setVisible(this$static, true);
  }
...
_.toJS_0 = function toJS(){
  ...
  if (this.playlist_0 != null) {
    var list = [];
    for (var source in this.playlist_0) {
      list.push(source.toJS());
    }
...
defineSeed(296, 1, {}, Gwtjwplayerwrapper_0);
function $$init_236(){
}
...
defineSeed(297, 250, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$Presenter, Q$PresenterWidget]), MainPagePresenter_0);
...
defineSeed(298, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), MainPagePresenter$1_0);
...
defineSeed(299, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), MainPagePresenter$2_0);
...
defineSeed(300, 281, makeCastMap([Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$MainPagePresenter$MyProxy]), MainPagePresenterMyProxyImpl_0);
...
defineSeed(301, 274, makeCastMap([Q$HasHandlers, Q$DelayedBind]), MainPagePresenterMyProxyImpl$WrappedProxy_0);
...
defineSeed(302, 255, makeCastMap([Q$IsWidget, Q$MainPagePresenter$MyView]), MainPageView_0);
...
defineSeed(303, 1, {}, fr_emmenemoi_gwt_widgets_jwplayer_example_client_gin_ClientGinjector_ClientGinjectorGinjector_fragment_8);
...
defineSeed(304, 1, {}, fr_emmenemoi_gwt_widgets_jwplayer_example_client_gin_ClientGinjector_ClientGinjectorGinjector_fragment$1_0);
...
defineSeed(305, 1, makeCastMap([Q$ClientGinjector]), fr_emmenemoi_gwt_widgets_jwplayer_example_client_gin_ClientGinjectorImpl_0);
...
defineSeed(306, 1, {}, fr_emmenemoi_gwt_widgets_jwplayer_example_client_gin_ClientGinjector_ClientGinjectorGinjector_0);
...
defineSeed(307, 1, {}, fr_emmenemoi_gwt_widgets_jwplayer_example_client_gin_ClientGinjector_ClientGinjectorGinjector_fragment_10);
function $$init_247(){
}
...
defineSeed(308, 268, makeCastMap([Q$ValueChangeHandler, Q$EventHandler, Q$HasHandlers, Q$Window$ClosingHandler]), ClientPlaceManager_0);
...
defineSeed(309, 1, {}, fr_emmenemoi_gwt_widgets_jwplayer_example_client_gin_ClientGinjector_ClientGinjectorGinjector_fragment_12);
function $$init_249(){
}
...
defineSeed(310, 19, makeCastMap([Q$Serializable, Q$Exception, Q$Throwable]), ArrayStoreException_0);
function $$init_250(){
}
...
defineSeed(312, 21, makeCastMap([Q$Serializable, Q$Throwable]));
function $$init_251(){
}
...
defineSeed(311, 312, makeCastMap([Q$Serializable, Q$Throwable]), AssertionError_0, AssertionError_1);
...
defineSeed(313, 1, makeCastMap([Q$Serializable, Q$Boolean, Q$Comparable]), Boolean_1);
...
defineSeed(316, 19, makeCastMap([Q$Serializable, Q$Exception, Q$Throwable]), ClassCastException_0);
function $$init_255(){
}
...
defineSeed(317, 19, makeCastMap([Q$Serializable, Q$Exception, Q$Throwable]), IllegalArgumentException_0);
function $$init_256(){
}
...
defineSeed(318, 19, makeCastMap([Q$Serializable, Q$Exception, Q$Throwable]), IllegalStateException_0, IllegalStateException_1);
function $$init_257(){
}
...
defineSeed(319, 19, makeCastMap([Q$Serializable, Q$Exception, Q$Throwable]), IndexOutOfBoundsException_0, IndexOutOfBoundsException_1);
function $$init_258(){
}
...
defineSeed(321, 1, makeCastMap([Q$Serializable, Q$Number]));
...
defineSeed(320, 321, makeCastMap([Q$Serializable, Q$Comparable, Q$Integer, Q$Number]), Integer_0);
...
defineSeed(324, 19, makeCastMap([Q$Serializable, Q$Exception, Q$Throwable]), NullPointerException_0, NullPointerException_1);
...
defineSeed(326, 1, makeCastMap([Q$Serializable, Q$StackTraceElement]), StackTraceElement_0);
...
defineSeed(329, 1, makeCastMap([Q$CharSequence]), StringBuffer_0);
...
defineSeed(330, 1, makeCastMap([Q$CharSequence]), StringBuilder_0, StringBuilder_1);
...
defineSeed(331, 19, makeCastMap([Q$Serializable, Q$Exception, Q$Throwable]), UnsupportedOperationException_0, UnsupportedOperationException_1);
function $$init_266(){
}
...
defineSeed(334, 1, makeCastMap([Q$Map]));
...
defineSeed(333, 334, makeCastMap([Q$Map]));
...
defineSeed(336, 332, makeCastMap([Q$Set]));
...
defineSeed(335, 336, makeCastMap([Q$Set]), AbstractHashMap$EntrySet_0);
...
defineSeed(337, 1, {}, AbstractHashMap$EntrySetIterator_0);
...
defineSeed(339, 1, makeCastMap([Q$Map$Entry]));
...
defineSeed(338, 339, makeCastMap([Q$Map$Entry]), AbstractHashMap$MapEntryNull_0);
...
defineSeed(340, 339, makeCastMap([Q$Map$Entry]), AbstractHashMap$MapEntryString_0);
...
defineSeed(341, 332, makeCastMap([Q$List]));
...
defineSeed(342, 1, {}, AbstractList$IteratorImpl_0);
...
defineSeed(343, 342, {}, AbstractList$ListIteratorImpl_0);
...
defineSeed(344, 336, makeCastMap([Q$Set]), AbstractMap$1_0);
...
defineSeed(345, 1, {}, AbstractMap$1$1_0);
...
defineSeed(346, 332, {}, AbstractMap$2_0);
...
defineSeed(347, 1, {}, AbstractMap$2$1_0);
...
defineSeed(348, 341, makeCastMap([Q$Serializable, Q$List]), ArrayList_0, ArrayList_1, ArrayList_2);
...
defineSeed(350, 1, {}, Collections$1_0);
function $$init_284(){
}
...
defineSeed(351, 341, makeCastMap([Q$Serializable, Q$List]), Collections$EmptyList_0);
...
defineSeed(352, 334, makeCastMap([Q$Serializable, Q$Map]), Collections$EmptyMap_0);
...
defineSeed(353, 336, makeCastMap([Q$Serializable, Q$Set]), Collections$EmptySet_0);
...
defineSeed(354, 1, {}, Collections$EmptySet$1_0);
...
defineSeed(355, 333, makeCastMap([Q$Serializable, Q$Map]), HashMap_0);
...
defineSeed(356, 336, makeCastMap([Q$Serializable, Q$Set]), HashSet_0);
...
defineSeed(357, 355, makeCastMap([Q$Serializable, Q$Map]), LinkedHashMap_0);
...
defineSeed(359, 339, makeCastMap([Q$Map$Entry]), MapEntryImpl_0);
...
defineSeed(358, 359, makeCastMap([Q$LinkedHashMap$ChainEntry, Q$Map$Entry]), LinkedHashMap$ChainEntry_0, LinkedHashMap$ChainEntry_1);
function $$init_293(){
}
...
defineSeed(360, 336, makeCastMap([Q$Set]), LinkedHashMap$EntrySet_0);
...
defineSeed(361, 1, {}, LinkedHashMap$EntrySet$EntryIterator_0);
...
defineSeed(362, 19, makeCastMap([Q$Serializable, Q$Exception, Q$Throwable]), NoSuchElementException_0, NoSuchElementException_1);
...
defineSeed(364, 1, makeCastMap([Q$Serializable]));
...
defineSeed(365, 364, makeCastMap([Q$Serializable]), Level$LevelAll_0);
...
defineSeed(366, 364, makeCastMap([Q$Serializable]), Level$LevelConfig_0);
...
defineSeed(367, 364, makeCastMap([Q$Serializable]), Level$LevelFine_0);
...
defineSeed(368, 364, makeCastMap([Q$Serializable]), Level$LevelFiner_0);
...
defineSeed(369, 364, makeCastMap([Q$Serializable]), Level$LevelFinest_0);
...
defineSeed(370, 364, makeCastMap([Q$Serializable]), Level$LevelInfo_0);
...
defineSeed(371, 364, makeCastMap([Q$Serializable]), Level$LevelOff_0);
...
defineSeed(372, 364, makeCastMap([Q$Serializable]), Level$LevelSevere_0);
...
defineSeed(373, 364, makeCastMap([Q$Serializable]), Level$LevelWarning_0);
