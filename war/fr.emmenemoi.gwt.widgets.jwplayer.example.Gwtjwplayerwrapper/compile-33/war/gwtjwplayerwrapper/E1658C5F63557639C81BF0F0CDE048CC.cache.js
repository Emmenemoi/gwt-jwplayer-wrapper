...
var $strongName = 'E1658C5F63557639C81BF0F0CDE048CC';
...
function $hasSomethingToPlay(this$static){
  return isNotNull(this$static.options.playlist_0) && !$isEmpty_1(this$static.options.playlist_0) || jsNotEquals(this$static.options.file_0, null) && jsNotEquals(this$static.options.file_0, '');
}
...
function $loadSources(this$static, sources){
  this$static.options.playlist_0 = sources;
  if (this$static.playerLoaded) {
    $loadPlayer(this$static, this$static.playerId);
    $setVisible(this$static, true);
  }
...
_.toJS = function toJS(){
  ...
  var playlist = this.playlist_0;
  if (!playlist.isEmpty()) {
    var list = [];
    for (var i = 0; i < playlist.size_1(); i++) {
      var source = playlist.get_3(i);
...
defineSeed(296, 1, {}, JWPlayerPlaylistSourceImpl_0);
