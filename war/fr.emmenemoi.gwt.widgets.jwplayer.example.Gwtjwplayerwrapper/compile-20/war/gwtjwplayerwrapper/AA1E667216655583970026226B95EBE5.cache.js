...
var $strongName = 'AA1E667216655583970026226B95EBE5';
...
function $setSource(this$static, source_0){
  this$static.source = source_0;
}
...
function $overrideSource(this$static, source_0){
  $setSource(this$static, source_0);
}
...
function fire_0(source_0, attached){
  var event_0;
  if (isNotNull(TYPE_1)) {
    event_0 = new AttachEvent_0(attached);
    source_0.fireEvent(event_0);
  }
}
...
function fire_1(source_0, target){
  fire_2(source_0, target, false);
}

function fire_2(source_0, target, autoClosed){
  var event_0;
  if (isNotNull(TYPE_2)) {
...
function fire_3(source_0, width_0, height){
  var event_0;
  if (isNotNull(TYPE_3)) {
...
function fire_4(source_0, value_0){
  var event_0;
  if (isNotNull(TYPE_4)) {
...
function HandlerManager_0(source_0){
  HandlerManager_1.call(this, source_0, false);
}

function HandlerManager_1(source_0, fireInReverseOrder){
  Object_1.call(this);
  $$init_89();
...
function setSourceOfEvent(event_0, source_0){
  $setSource(event_0, source_0);
}
...
function $doAdd(this$static, type_0, source_0, handler){
  if (isNull(type_0)) {
  ...
  this$static.firingDepth > 0?$enqueueAdd(this$static, type_0, source_0, handler):$doAddNow(this$static, type_0, source_0, handler);
  return new SimpleEventBus$1_0(this$static, type_0, source_0, handler);
}

function $doAddNow(this$static, type_0, source_0, handler){
  var l_0;
  l_0 = $ensureHandlerList(this$static, type_0, source_0);
  l_0.add_1(handler);
}

function $doFire(this$static, event_0, source_0){
  ...
  try {
    ...
    jsNotEquals(source_0, null) && setSourceOfEvent(event_0, source_0);
    handlers = $getDispatchList(this$static, event_0.getAssociatedType(), source_0);
    causes = null;
...
function $doRemove(this$static, type_0, source_0, handler){
  this$static.firingDepth > 0?$enqueueRemove(this$static, type_0, source_0, handler):$doRemoveNow(this$static, type_0, source_0, handler);
}

function $doRemoveNow(this$static, type_0, source_0, handler){
  var l_0, removed;
  l_0 = $getHandlerList(this$static, type_0, source_0);
  removed = l_0.remove_2(handler);
  removed && l_0.isEmpty() && $prune(this$static, type_0, source_0);
}

function $enqueueAdd(this$static, type_0, source_0, handler){
  $defer(this$static, new SimpleEventBus$2_0(this$static, type_0, source_0, handler));
}

function $enqueueRemove(this$static, type_0, source_0, handler){
  $defer(this$static, new SimpleEventBus$3_0(this$static, type_0, source_0, handler));
}

function $ensureHandlerList(this$static, type_0, source_0){
  ...
  handlers = dynamicCast(sourceMap.get_2(source_0), Q$List);
  if (isNull(handlers)) {
    handlers = new ArrayList_0;
    sourceMap.put(source_0, handlers);
  }
  return handlers;
}
...
function $getDispatchList(this$static, type_0, source_0){
  var directHandlers, globalHandlers, rtn;
  directHandlers = $getHandlerList(this$static, type_0, source_0);
  if (jsEquals(source_0, null)) {
...
function $getHandlerList(this$static, type_0, source_0){
  var handlers, sourceMap;
  sourceMap = dynamicCast(this$static.map_0.get_2(type_0), Q$Map);
  if (isNull(sourceMap)) {
    return emptyList();
...
function $prune(this$static, type_0, source_0){
  var pruned, sourceMap;
  sourceMap = dynamicCast(this$static.map_0.get_2(type_0), Q$Map);
  pruned = dynamicCast(sourceMap.remove_3(source_0), Q$List);
  if (isNull(pruned)) {
    debugger;
...
;
_.doRemove = function doRemove(type_0, source_0, handler){
  $doRemove(this, type_0, source_0, handler);
}
;
...
;
_.fireEventFromSource = function fireEventFromSource(event_0, source_0){
  if (jsEquals(source_0, null)) {
    throw new NullPointerException_1('Cannot fire from a null source');
  }
  $doFire(this, event_0, source_0);
}
;
_.firingDepth = 0;
...
_.doRemove = function doRemove_0(type_0, source_0, handler){
  $doRemove(this, type_0, source_0, handler);
}
;
function $$init_93(){
...
function fire_6(source_0){
  $clinit_AsyncCallStartEvent();
  source_0.fireEvent_0(new AsyncCallStartEvent_0);
}
...
function fire_7(source_0){
  $clinit_AsyncCallSucceedEvent();
  source_0.fireEvent_0(new AsyncCallSucceedEvent_0);
}
...
function fire_8(source_0, lock){
  source_0.fireEvent(new LockInteractionEvent_0(lock));
}
...
function fire_9(source_0, request){
  $clinit_NavigationEvent();
  source_0.fireEvent(new NavigationEvent_0(request));
}
...
function fire_10(source_0){
  $clinit_NavigationRefusedEvent();
  source_0.fireEvent(new NavigationRefusedEvent_0);
}
...
function fire_11(source_0){
  $clinit_ResetPresentersEvent();
  source_0.fireEvent(new ResetPresentersEvent_0);
}
...
function fire_12(source_0, type_0, content_0){
  source_0.fireEvent(new RevealContentEvent_0(type_0, content_0));
}
...
function fire_13(source_0, content_0){
  $clinit_RevealRootContentEvent();
  source_0.fireEvent(new RevealRootContentEvent_0(content_0));
}
...
function fire_14(source_0, content_0){
  $clinit_RevealRootLayoutContentEvent();
  source_0.fireEvent(new RevealRootLayoutContentEvent_0(content_0));
}
...
function fire_15(source_0, content_0){
  $clinit_RevealRootPopupContentEvent();
  fire_16(source_0, content_0, true);
}

function fire_16(source_0, content_0, center){
  source_0.fireEvent(new RevealRootPopupContentEvent_0(content_0, center));
}
...
_.toJS = function toJS(){
  ...
  if (this.playlist_0 != null && this.playlist_0.length > 0) {
    var list = [];
    debugger;
    for (var i = 0; i < this.playlist_0.length; i++) {
      list[list.length] = source[i].toJS;
    }
