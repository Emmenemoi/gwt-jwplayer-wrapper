...
public class MainPagePresenterMyProxyImpl extends com.gwtplatform.mvp.client.proxy.ProxyPlaceImpl<MainPagePresenter> implements fr.emmenemoi.gwt.widgets.jwplayer.example.client.core.MainPagePresenter.MyProxy, com.gwtplatform.mvp.client.DelayedBind {
  
  private fr.emmenemoi.gwt.widgets.jwplayer.example.client.gin.ClientGinjector ginjector;
  ...
  extends com.gwtplatform.mvp.client.proxy.ProxyImpl<MainPagePresenter> implements com.gwtplatform.mvp.client.DelayedBind {
    ...
    public void delayedBind(Ginjector baseGinjector) {
      ginjector = (fr.emmenemoi.gwt.widgets.jwplayer.example.client.gin.ClientGinjector)baseGinjector;
